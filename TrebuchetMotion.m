...
h     =   320/100;      % Pole height, from ground to axis of rotation

l_al  =   570/100;      % Long arm length
l_acg =    60/100;      % Arm center of gravity, distance measured from the rotation axis 
l_as  =    120/100;      % Short arm length
l_c   =   14/100;      % Length of counterweight
l_s   =   500/100;      % Sling length

m_a   =  0.00;      % Mass of the arm
m_c   = 2000.00;      % Mass of the counterweight
m_p   =   15.00;      % Mass of the projectile

I_a   =   100.0;     % Inertia of arm
